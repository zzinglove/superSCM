...
export const menuItems: MenuItem[] = [
  ...
  { href: '/analysis/leadtime', label: '리드타임 격차', icon: BarChart3, roles: ['USER', 'ADMIN'], section: '분석' },
  { href: '/analysis/stockout', label: '재고 소진 위험', icon: Boxes, roles: ['USER', 'ADMIN'], section: '분석' },
  { href: '/analysis/purchase-recommendation', label: 'Purchase Recommendation', icon: Boxes, roles: ['USER', 'ADMIN'], section: '분석' },
  { href: '/analysis/demand-profile', label: '수요 프로파일', icon: BarChart3, roles: ['USER', 'ADMIN'], section: '분석' },
  { href: '/analysis/model-comparison', label: '모델 비교', icon: BarChart3, roles: ['USER', 'ADMIN'], section: '분석' },
  ...
  { href: '/admin/leadtime', label: 'SCM Policies · Lead Time', icon: Settings2, roles: ['ADMIN'], section: '관리' },
  { href: '/admin/safety-stock', label: 'SCM Policies · Safety Stock', icon: Settings2, roles: ['ADMIN'], section: '관리' },
